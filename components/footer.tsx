        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/privacy" className="text-muted-foreground hover:text-foreground text-sm transition">Privacy</a></li>
              <li><a href="/terms" className="text-muted-foreground hover:text-foreground text-sm transition">Terms</a></li>
            </ul>
          </div>
        </div>
